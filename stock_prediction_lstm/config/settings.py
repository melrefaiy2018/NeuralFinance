    ...
    def load_api_keys(cls):
        ...
        try:
            ...
            if ALPHA_VANTAGE_API_KEY == "YOUR_API_KEY_HERE":
                ...
                print(f"1. Navigate to: {os.path.abspath(os.path.join(os.path.dirname(__file__), 'keys'))}")
            ...
            print("Get your free Alpha Vantage API key at: https://www.alphavantage.co/support/#api-key")
            print("=" * 50)
            return False
